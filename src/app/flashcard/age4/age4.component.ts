...
export class Age4Component implements OnInit {
  ...
  updateMetaTags(){
    this.title.setTitle("Digital flashcards for speech development at Age 4");
    ...
    this.meta.updateTag(  {property : "og:title", content: "Digital flashcards for speech development at Age 4"});
  }
